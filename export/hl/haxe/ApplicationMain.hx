...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("LunarLib", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("LunarLib", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "LunarLib";
		app.meta["name"] = "LunarLib";
